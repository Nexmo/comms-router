...
public class ExpressionResource extends ApiObjectResource<ExpressionDto> {
  ...
  @Override
  protected PaginatedService<ExpressionDto> getService() {
  ...
  public Response create(CreateExpressionArg arg)
    ...
    ApiObjectId apiObjectId = expressionService.create(arg);
  ...
  public Response create(@PathParam("resourceId") String resourceId, CreateExpressionArg arg)
    ...
    ApiObjectId apiObjectId = expressionService.create(arg, resourceId);
    return createResponse(apiObjectId);
  }
  ...
  public void update(@PathParam("resourceId") String resourceId, UpdateExpressionArg arg)
    ...
    expressionService.update(arg, resourceId);
  }
