 ...
 */
@Provider
public class PreconditionFailedMapper extends BaseExceptionMapper<PreconditionFailedException> {

  public PreconditionFailedMapper() {
    super(Status.PRECONDITION_FAILED);
  }

  @Override
  protected ExceptionPresentation getExceptionPresentation(PreconditionFailedException exception) {
