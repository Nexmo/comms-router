...
public class SkillValidatorTest extends TestBase {
  ...
  private void createNumericSkill(String name, double b1, boolean inclusiveB1, double b2, boolean inclusiveB2, boolean multivalue, String routerRef) throws CommsRouterException {
